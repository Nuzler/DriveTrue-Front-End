    ...
    <div>
      ...
      <div className='flex flex-col  pt-7'>
        ...
        <div class="flex items-center mb-4">
            <input id="pickup-option-1" type="radio" name="pickupOption" value="now" checked={form.pickupOption === "now"} onChange={handleChange} class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="pickup-option-1" aria-describedby="pickup-option-1" />
        ...
        <div class="flex items-center mb-4">
            <input id="pickup-option-2" type="radio" name="pickupOption" value="later" checked={form.pickupOption === "later"} onChange={handleChange} class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="pickup-option-2" aria-describedby="pickup-option-2"/>
